...
#define cpu_map_h
  ...
  #define X_STEP_BIT      7  // Uno Digital Pin 2
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
      ...
      #else
        #define SPINDLE_ENABLE_BIT    11  // Uno Digital Pin 11
      #endif
    #else
    ...
    #define SPINDLE_PWM_MAX_VALUE     25 // Don't change. 328p fast PWM mode fixes top value as 255.
    #ifndef SPINDLE_PWM_MIN_VALUE
      #define SPINDLE_PWM_MIN_VALUE   13 // Must be greater than zero.
    #endif
